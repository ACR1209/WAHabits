...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference("Reminder.count") do
      post reminders_url, params: { reminder: { description: @reminder.description, done: @reminder.done, due: @reminder.due, title: @reminder.title } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { description: @reminder.description, done: @reminder.done, due: @reminder.due, title: @reminder.title } }
